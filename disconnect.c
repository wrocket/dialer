...
int dialer_disconnect(char * numberToDial){
	...
	request[0] = '\0';
	strcat(request, "GET /cgi-bin/testcgi?AcTiOnNeXt=%2Fhtdocs%2Fstatus.html&CoNnEcTNoW=disconnect&sta_version=2.0.0.0.19n-R7000M&MoDeMStAtUs=Connected&DiScReAsOn=None&sta_type=PPP&CoNnEcTtSpEeD=45333&WaNmAsK=255.255.255.0&CuRrEnTnUmBeR=");
